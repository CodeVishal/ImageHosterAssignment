...
public class ImageController {
    ...
    //This method is called when the details of the specific image with corresponding title  & ID are to be displayed
    //The logic is to get the image from the databse with corresponding title & ID . After getting the image from the database the details are shown
    //First receive the dynamic parameter in the incoming request URL in a string variable 'title' and ID  also the Model type object
   ...
   // Added check  around edit image to check non -owner & owner of image & enabled edit only for owner of image
    // if non owner of image tries to edit will get error message .
    ...
    //Added check for non owner and owner of image while deleting it
    // Owner of image will be able to delete image but non owner will get error message.
